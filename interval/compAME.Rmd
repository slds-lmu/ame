...
split.points = partitionDerivative(df$x1, poly12.ime$x1, 1)
split.points = partitionDerivative(df$x1[-74], poly12.ime$x1[-74], 1) # ohne Ausreißer
split.points = partitionDerivative(df$x1[-74], poly12.ime$x1[-74], 5) # ohne Ausreißer
